...
class LineFollower(object):
    ...
    def __init__(self):
        ...
        self.image_sub = rospy.Subscriber(
            "/maze_robot/camera1/image_raw", Image, self.camera_callback)
    ...
    def camera_callback(self, data):
        ...
        descentre = 220
        rows_to_watch = 20
        # [(height)/2+descentre:(height) /2+(descentre+rows_to_watch)][1:width]
        crop_img = cv_image[int(
            (height/2)+descentre): int((height/2)+descentre+rows_to_watch), 1: width-1]
